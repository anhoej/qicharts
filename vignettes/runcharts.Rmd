...
- A **shift signal** is present if any run of consecutive data points on the same side of the median is longer than the prediction limit, `round(log2(n) + 3)`. Data points that fall on the median do not count, they do neither break nor contribute to the run.

- A **crossings signal** is present if the number of times the graph crosses the median is smaller than the prediction limit, `qbinom(0.05, n - 1, 0.5)`.
